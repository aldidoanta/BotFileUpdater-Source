...
public enum ItemRecipe {
	...
	Abyssal("Abyssal Blade", "item_relic;item_abyssal_blade", new ItemRecipe[]{ItemRecipe.Basher}),
	Veil("Veil of Discord", "item_helm_of_iron_will;item_recipe_veil_of_discord", new ItemRecipe[]{ItemRecipe.NullTalisman}),
	SolarCrest("Solar Crest", "item_talisman_of_evasion;item_solar_crest", new ItemRecipe[]{ItemRecipe.Medallion}),
	Drums("Drums of Endurance", "item_robe;item_recipe_ancient_janggo", new ItemRecipe[]{ItemRecipe.Bracer}),
	OctarineCore("Octarine Core", "item_mystic_staff;item_octarine_core", new ItemRecipe[]{ItemRecipe.SoulBooster}),
